...
public class TodosController {
    ...
    @ApiOperation(value = "Delete a todo", notes = "Provide todoId in path", response = TodoDto.class)
    ...
    @ApiOperation(value = "Delete all todos for a user", notes = "Provide userId in path", response = TodoDto.class)
